...
$updated_at = "";
		...
		$params = array(
					 'financial_year_name' => html_escape($this->input->post('financial_year_name')),
...
$this->db->or_like('financial_year_name', $key, 'both');
...
$this->db->or_like('updated_at', $key, 'both');
	...
	function export($export_type='CSV'){
	  if($export_type=='CSV'){	
		   ...
		   $header = array("Id","Financial Year Name","Status","Created At","Updated At"); 
		   fputcsv($file, $header);
