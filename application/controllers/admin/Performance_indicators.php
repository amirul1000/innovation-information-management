...
class Performance_indicators extends CI_Controller{
	 ...
	 *@param $start - Starting of performance_indicators table's index to get query
	 *
	 */
...
$this->db->or_like('updated_at', $key, 'both');
	...
	function export($export_type='CSV'){
	  if($export_type=='CSV'){	
		   ...
		   $header = array("Id","Activities Id","Unit","Wop Indicators","Order No","Created At","Updated At"); 
		   fputcsv($file, $header);
