...
class Predefined_innovation_plan extends CI_Controller{
	 ...
	 *@param $start - Starting of predefined_innovation_plan table's index to get query
	 *
	 */
...
$this->db->or_like('updated_at', $key, 'both');
	...
	function export($export_type='CSV'){
	  if($export_type=='CSV'){	
		   ...
		   $header = array("Id","Predefined Activities Id","Plan","Performance Indicators","Weight Of Plan","Sl No","Created At","Updated At"); 
		   fputcsv($file, $header);
