...
<div class="div-table">
    <div class="div-table-row headerbar"> 
        ...
        <div class="div-table-col large-col sh show"><a href="javascript:void()" class="action-icon" data-toggle="modal"
			data-target="#objectives"> <i
				class="zmdi zmdi-plus"></i></a><strong>কর্ম সম্পাদন ক্ষেত্র </strong></div>
    ...
    <div class="div-table-row <?=$color1_cls?>">
        ...
        <div class="div-table-col sh show"><?php echo eng_to_bengali_number($c['weight_of_objectives']); ?>
            <a href="javascript:void();" onClick="objectives_edit_view(<?=$c['id']?>);"><i
				class="zmdi zmdi-edit"></i></a>
        </div>
        
        <div  class="div-table-col" style="width:<?=$width1?>px;"> 
             <a href="javascript:void()" onClick="openModalActivities(<?php echo $c['id']; ?>);"> <i class="zmdi zmdi-plus"></i></a>
             <div   class="div-table">
                <?php
				    $this->db->order_by('order_no', 'asc');
                ...
                <div class="div-table-row <?=$color2_cls?>">
                   <div   class="div-table-col large-col sh show">[<?=eng_to_bengali_number($a['sl_no'])?>]<?php echo $a['activities_name'];  ?>
                     <a href="javascript:void();" onClick="activities_edit_view(<?=$a['id']?>);"><i
						class="zmdi zmdi-edit"></i></a>
                   </div>
                   <div   class="div-table-col"  style="width:<?=$width2?>px;">
                     <div  class="div-table">
                        <a href="javascript:void()" onClick="openModalPlan(<?php echo $a['id']; ?>);"> <i class="zmdi zmdi-plus"></i></a>
                        <?php
                        ...
                        <div class="div-table-row">
							  ...
							  ?>
                               ...
                               <div  class="div-table-col">
                              <a href="javascript:void();" onClick="plan_edit_view(<?=$c1['id']?>);"><i
								class="zmdi zmdi-edit"></i></a>
                      		  </div>
