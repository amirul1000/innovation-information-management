<a  href="<?php echo site_url('admin/performance_indicators/index'); ?>" class="btn btn-info"><i class="arrow_left"></i> List</a>
         ...
         <div class="col-md-8"> 
          ...
          <select name="activities_id"  id="activities_id"  class="form-control"/> 
            ...
            <?php 
             ...
             {  
            ?> 
            <option value="<?=$dataArr[$i]['id']?>" <?php if($performance_indicators['activities_id']==$dataArr[$i]['id']){ echo "selected";} ?>><?=$dataArr[$i]['activities_name']?></option> 
            <?php 
             } 
            ?> 
          </select> 
          ...
          <div class="col-md-8"> 
           ...
           <select name="unit"  id="unit"  class="form-control"/> 
             ...
             <?php 
              ...
              { 
             ?> 
             <option value="<?=$enumArr[$i]?>" <?php if($performance_indicators['unit']==$enumArr[$i]){ echo "selected";} ?>><?=ucwords($enumArr[$i])?></option> 
             <?php 
              } 
             ?> 
           </select> 
...
<div class="form-group"> 
          <label for="Wop Indicators" class="col-md-4 control-label">Wop Indicators</label> 
          <div class="col-md-8"> 
           <input type="text" name="wop_indicators" value="<?php echo ($this->input->post('wop_indicators') ? $this->input->post('wop_indicators') : $performance_indicators['wop_indicators']); ?>" class="form-control" id="wop_indicators" /> 
          </div> 
           </div>
<div class="form-group"> 
          <label for="Order No" class="col-md-4 control-label">Order No</label> 
          <div class="col-md-8"> 
           <input type="text" name="order_no" value="<?php echo ($this->input->post('order_no') ? $this->input->post('order_no') : $performance_indicators['order_no']); ?>" class="form-control" id="order_no" /> 
          </div> 
           </div>
