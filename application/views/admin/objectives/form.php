<a  href="<?php echo site_url('admin/objectives/index'); ?>" class="btn btn-info"><i class="arrow_left"></i> List</a>
         ...
         <div class="col-md-8"> 
          ...
          <select name="department_id"  id="department_id"  class="form-control"/> 
            ...
            <?php 
             ...
             {  
            ?> 
            <option value="<?=$dataArr[$i]['id']?>" <?php if($objectives['department_id']==$dataArr[$i]['id']){ echo "selected";} ?>><?=$dataArr[$i]['department']?></option> 
            <?php 
             } 
            ?> 
          </select> 
...
<div class="form-group"> 
          ...
          <div class="col-md-8"> 
           <input type="text" name="financial_year" value="<?php echo ($this->input->post('financial_year') ? $this->input->post('financial_year') : $objectives['financial_year']); ?>" class="form-control" id="financial_year" /> 
          </div> 
           </div>
<div class="form-group"> 
...
<div class="form-group"> 
          ...
          <div class="col-md-8"> 
           <input type="text" name="objectives_name" value="<?php echo ($this->input->post('objectives_name') ? $this->input->post('objectives_name') : $objectives['objectives_name']); ?>" class="form-control" id="objectives_name" /> 
          </div> 
           </div>
<div class="form-group"> 
          <label for="Weight Of Objectives" class="col-md-4 control-label">Weight Of Objectives</label> 
          <div class="col-md-8"> 
           <input type="text" name="weight_of_objectives" value="<?php echo ($this->input->post('weight_of_objectives') ? $this->input->post('weight_of_objectives') : $objectives['weight_of_objectives']); ?>" class="form-control" id="weight_of_objectives" /> 
          </div> 
           </div>
