...
<div>
	<div class="float_left padding_10">
		<a href="<?php echo site_url('admin/predefined_innovation_plan/save'); ?>"
...
<td><?php echo $c['sl_no']; ?></td>
		...
		<td>
            <a href="<?php echo site_url('admin/predefined_innovation_plan/details/'.$c['id']); ?>"  class="action-icon"> <i class="zmdi zmdi-eye"></i></a>
            <a href="<?php echo site_url('admin/predefined_innovation_plan/save/'.$c['id']); ?>" class="action-icon"> <i class="zmdi zmdi-edit"></i></a>
            <a href="<?php echo site_url('admin/predefined_innovation_plan/remove/'.$c['id']); ?>" onClick="return confirm('Are you sure to delete this item?');" class="action-icon"> <i class="zmdi zmdi-delete"></i></a>
        </td>
    </tr>
	<?php } ?>
</table>
